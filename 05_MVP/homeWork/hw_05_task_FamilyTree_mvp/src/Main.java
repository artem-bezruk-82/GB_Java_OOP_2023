...
*/
        ...
        //Model model = new Model("romanov.dat");
        Model model = new Model("family.dat");
        System.out.println(model.getFamily().toString());
        //Human human = null;
        //try
        //{
        //    human = new Human();
        //    human.setName("Test Human 2");
        //}
        //catch (Exception exception)
        //{
        //   System.out.println(exception.getMessage());
        //}
        //model.getFamily().AddFamilyMember(human);
        //model.save();
